...
import { FileCode2, User, Mail, Lock, ArrowRight, CheckCircle2, RefreshCw } from "lucide-react";
        ...
        <div className="min-h-[90vh] flex items-center justify-center px-4 py-12">
            <div className="max-w-md w-full">
                <div className="text-center mb-10">
                    ...
                    <p className="mt-2 text-gray-600">Get unlimited access to all AI tools</p>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-start space-x-3 py-2">
                            <input type="checkbox" required className="mt-1 h-4 w-4 text-red-600 border-gray-300 rounded focus:ring-red-500" />
