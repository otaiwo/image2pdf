...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        primary: 'bg-red-600 text-white hover:bg-red-700 shadow-sm shadow-red-500/20',
        secondary: 'bg-gray-900 text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100',
        outline: 'border border-gray-200 bg-transparent hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300',
